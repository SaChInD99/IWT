...
<body>
        ...
        <table border="0" width="100%" class="table1">
            <tr>
                ...
                <th width="33%" align="right">
                    <a href="#"><button class="b1"><b class="b3">Log-in</b></button></a><br /><br />
                    <a href="Signup1.html"><button class="b1"><b class="b3">Sign-in</b></button></a>
                </th>
            </tr>
        </table>
        <hr class="hl" />
        <ul class="menu">
            <li class="left"><a href="../html/homepage.html"><b class="b2">Home</b></a></li>
            <li class="left"><a href="../html/Content.html"><b class="b2">Content</b></a></li>
            <li class="left"><a href="../html/contactindex.html"><b class="b2">Contact us</b></a></li>
            <li class="left"><a href="../html/About_Us.html"><b class="b2">About us</b></a></li>
        </ul>
        <br><br>
    </div>
    ...
    <div class="login">
        ...
        <h1 class="h1" style="font-size: 60px">Login Page</h1><br>
          
        <label><b>User Name</b></label>
        <input type="text" id="uname" name="username" placeholder="username" required><br><br>
        <label><b>Password</b></label>
        <input type="password" id="pword" name="password" placeholder="password" required><br><br>
        <button type="reset"  id="log">Reset</button><br><br>
        ...
        <table width="100%">
           <tr><td><b>
            ...
            <td align="right">
                ...
                <br />
                <a href="https://twitter.com/login?lang=en"><img src="../images/fi4.jpg" width="40px" /></a></h2>
            </td>
            </tr>
        </table>
    </div>
